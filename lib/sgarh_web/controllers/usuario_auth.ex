defmodule SgarhWeb.UsuarioAuth do
  import Plug.Conn
  ...
  def log_out_usuario(conn) do
    ...
    usuario_token && Contas.delete_session_token(usuario_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      SgarhWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_usuario(conn, _opts) do
    ...
    usuario = usuario_token && Contas.get_usuario_by_session_token(usuario_token)
